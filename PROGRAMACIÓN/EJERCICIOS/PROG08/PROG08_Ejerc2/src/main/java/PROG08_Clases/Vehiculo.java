 ...
 * Implementa Comparator que sirve para poder comparar dos vehículos 
 * @author bgher
 */
...
public class Vehiculo implements Comparable <Vehiculo> {
    ...
    /**
     * Compara la matricula de vehiculo con la matricula de otro
     * @param v
     * @return numero negativo si es menor 
     *         numero positivo si es mayor 
     *         0 si es igual
     */
    @Override
